...
class ZhClipWrapper(nn.Module):
    def __init__(self):
        super().__init__()
        self.model = ZhCLIPModel.from_pretrained('nlpcver/zh-clip-vit-roberta-large-patch14')
        processor = ZhCLIPProcessor.from_pretrained('nlpcver/zh-clip-vit-roberta-large-patch14')
